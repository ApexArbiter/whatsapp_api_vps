...
const headless = process.env.HEADLESS
  ...
  : true;
const releaseBrowserLock = process.env.RELEASE_BROWSER_LOCK
  ? process.env.RELEASE_BROWSER_LOCK.toLowerCase() === "true"
  : true;
const logLevel = process.env.LOG_LEVEL || "info";
const enableWebHook = process.env.ENABLE_WEBHOOK
  ? process.env.ENABLE_WEBHOOK.toLowerCase() === "true"
  : true;
const enableWebSocket = process.env.ENABLE_WEBSOCKET
  ? process.env.ENABLE_WEBSOCKET.toLowerCase() === "true"
  : false;
const autoStartSessions = process.env.AUTO_START_SESSIONS
  ? process.env.AUTO_START_SESSIONS.toLowerCase() === "true"
  : true;
